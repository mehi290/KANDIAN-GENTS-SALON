  ...
  return (
    <button
      ...
      style={{
        ...
        background: outlined ? "transparent" : "#3B5C55",
        color: outlined ? "#3B5C55" : "#ffffff",
        border: outlined ? "1.5px solid #3B5C55" : "1.5px solid #3B5C55",
        borderRadius: 2,
        cursor: "pointer",
  ...
  useEffect(() => {
    ...
    style.innerHTML = `
      ...
      * { box-sizing: border-box; }
      ...
      .eyebrow { font-family:'Inter',sans-serif; font-size:11px; text-transform:uppercase; letter-spacing:0.28em; color:#3B5C55; font-weight:500; }
      ...
      .ws-nav-link::after { content:''; position:absolute; left:0; bottom:0; height:1px; width:0; background:#3B5C55; transition: width 0.3s ease;}
      .ws-nav-link:hover { color:#3B5C55; }
      .ws-nav-link:hover::after { width:100%; }
      .ws-btn[data-outlined="1"]:hover { background:#3B5C55 !important; color:#ffffff !important; }
      ...
      .barber-img-wrap:hover img { outline:2px solid #3B5C55; outline-offset:6px; }
      .footer-link:hover { color:#3B5C55 !important; }
    ...
    <div style={{ background: "#111111", color: "#E8E0D5", overflowX: "hidden" }}>
      ...
      >
                  ...
                  {SUB_SERVICES.map((s) => (
                    <div key={s.name} style={{ marginBottom: 15 }}>
                      <div
                        ...
                        onMouseEnter={(e) => e.currentTarget.style.color = "#3B5C55"}
        ...
        <button
          ...
          style={{ background: "transparent", border: "none", color: "#3B5C55", cursor: "pointer" }}
                ...
                <div key={l.name} style={{ textAlign: "center" }}>
                  ...
                  {l.dropdownKey === "services" && activeDropdown === l.dropdownKey && (
                    <div style={{ marginTop: 20, display: "flex", flexDirection: "column", gap: 15 }}>
                      {SUB_SERVICES.map((s) => (
                        <div key={s.name}>
                          <div style={{ fontSize: 16, color: "#3B5C55", fontWeight: 600 }}>{s.name}</div>
                          {s.sub && (
                  ...
                  {l.dropdownKey === "priceList" && activeDropdown === l.dropdownKey && (
                    <div style={{ marginTop: 20, display: "flex", flexDirection: "column", gap: 15 }}>
                      {PRICE_LIST_SUB.map((s) => (
                        <div key={s.name} style={{ fontSize: 24, color: "#3B5C55" }}>{s.name}</div>
                      ))}
                    </div>
                  )}
      ...
      >
        ...
        >
          <source src="/kanadian hero video.mp4" type="video/mp4" />
        </video>
        <div
          style={{
            position: "absolute",
      ...
      {/* GOLD STATS BAR */}
      <section style={{ background: "#3B5C55", padding: "10px 40px" }}>
        <div
          style={{
            maxWidth: 1200,
            margin: "0 auto",
        ...
        <div className="ws-container">
          <Reveal>
            ...
            >
              ...
              <img
                src="/kanadian about.png"
                alt="About Kandian Gents Salon"
                style={{
                  width: "100%",
                  height: isMobile ? 300 : 540,
                  objectFit: "cover",
                  outline: "1px solid #3B5C55",
      ...
      <section style={{ background: "#111", padding: "60px 0 100px", position: "relative" }}>
        <div className="ws-container">
          <div style={{ textAlign: "center", marginBottom: 60 }}>
            ...
            <div style={{ width: 60, height: 2, background: "#3B5C55", margin: "0 auto 20px" }} />
            <p style={{ color: "#888", fontSize: 15, maxWidth: 700, margin: "0 auto", lineHeight: 1.6 }}>
              With 4 Google Reviews and a 5.0 rating our professional barbers guarantee unmatched
                ...
                <React.Fragment key={loopIdx}>
                  {[
                    ...
                    <div key={`${loopIdx}-${idx}`} style={{
                      ...
                      display: "flex", flexDirection: "column", gap: 25, borderTop: "4px solid #3B5C55",
                      position: "relative"
                    }}>
                      <div style={{ display: "flex", gap: 4, marginBottom: -10 }}>
                        {[...Array(5)].map((_, i) => <Star key={i} size={14} fill="#3B5C55" color="#3B5C55" />)}
                      </div>
                      <Quote size={32} color="#3B5C55" style={{ opacity: 0.8 }} />
                      <p style={{
                      ...
                      <div style={{ marginTop: "auto", display: "flex", gap: 15, alignItems: "center" }}>
                        <div style={{
                          width: 40, height: 40, borderRadius: "50%", background: "#3B5C55",
          ...
          <div style={{
            display: "flex", alignItems: "center", justifyContent: "center",
            gap: isMobile ? 15 : 40, marginTop: 50, color: "#3B5C55",
      ...
      <section className="ws-section" style={{ background: "#111111", color: "#E8E0D5", padding: "40px 0 100px" }}>
        <div className="ws-container">
          ...
          >
            <Instagram size={18} color="#3B5C55" />
            <span>Follow our work on Instagram</span>
            <span style={{ color: "#3B5C55", fontWeight: 600 }}>@kandian__gents__salon</span>
            <ArrowRight size={14} color="#3B5C55" />
          </a>
        </div>
      </section>
            ...
            {[
              ...
              <div
                ...
                style={{
                  background: card.bg,
                  padding: "48px 40px",
                  border: card.bordered ? "1px solid #3B5C55" : "1px solid #2A2A2A",
                  position: "relative",
                }}
              >
                {card.popular && (
                ...
                <div style={{ marginTop: 28 }}>
                  {card.title === "SIGNATURE" ? (
                    ...
                    <GoldButton onClick={() => openBook()} full>
                      BOOK NOW
                    </GoldButton>
                  )}
                </div>
            ...
            >
              <div>
                ...
                <div style={{ marginTop: 32, display: "flex", flexDirection: "column", gap: 18 }}>
                  {[
                    { Icon: MapPin, color: "#3B5C55", text: "Al Khazna Centre - Al Karama - Dubai" },
                    { Icon: Phone, color: "#3B5C55", text: "0557204456" },
                    { Icon: Clock, color: "#3B5C55", text: loc.hours },
                    {
                      Icon: MessageCircle,
                      color: "#25D366",
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          >
            <div>
              <div
                className="bebas"
                style={{ fontSize: 30, color: "#3B5C55", letterSpacing: "0.2em" }}
              >
                KANDIAN GENTS SALON
              </div>
              <div
      ...
      {open && (
        ...
        >
          <motion.div
            ...
            style={{
              background: step === 4 ? "#3B5C55" : "#1A1A1A",
              color: "#fff",
              maxWidth: 560,
              width: "100%",
              maxHeight: "90vh",
              ...
              >
                    ...
                    {SERVICES.map((s) => (
                      <button
                        ...
                        style={{
                          ...
                          textAlign: "left",
                          padding: "16px 20px",
                          background: service === s.name ? "#3B5C55" : "transparent",
                          color: service === s.name ? "#fff" : "#E8E0D5",
                    ...
                    {[...BARBERS.map((b) => b.name), "No preference"].map((n) => (
                      <button
                        ...
                        style={{
                          ...
                          textAlign: "left",
                          padding: "16px 20px",
                          background: barber === n ? "#3B5C55" : "transparent",
                          color: barber === n ? "#fff" : "#E8E0D5",
                          border: "1px solid #333",
                          marginBottom: 8,
                          cursor: "pointer",
                          fontSize: 14,
                      ...
                      {days.map((d) => {
                        ...
                        return (
                          <button
                            ...
                            style={{
                              padding: "10px 4px",
                              background: sel ? "#3B5C55" : "#222",
                              color: sel ? "#fff" : "#E8E0D5",
                              border: "none",
                              cursor: "pointer",
                              fontSize: 11,
                              fontFamily: "Inter",
                    ...
                    <div style={{ display: "flex", gap: 10, marginTop: 28 }}>
                      ...
                      <button
                        ...
                        style={{
                          flex: 2,
                          padding: "14px",
                          background: !date || !time ? "#444" : "#3B5C55",
                          color: "#fff",
                          border: "none",
                    ...
                    <div style={{ display: "flex", gap: 10 }}>
                      ...
                      <button
                        ...
                        style={{
                          flex: 2,
                          padding: 14,
                          background: !name || !phone ? "#444" : "#3B5C55",
                          color: "#fff",
                          border: "none",
                ...
                {step === 4 && (
                  <div style={{ textAlign: "center" }}>
                    <h3 className="bebas" style={{ fontSize: 48, color: "#fff", margin: "10px 0 20px" }}>
